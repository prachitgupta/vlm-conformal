#!/usr/bin/env python3
"""Five-trial baseline evaluation with no tools for Assignment 3."""
...
def run_baseline(args: argparse.Namespace | None = None) -> dict[str, Any]:
    ...
    for problem_id in _problem_ids(parsed.problem_id):
        ...
        for trial in range(1, parsed.trials + 1):
            ...
            print(f"{problem_id} trial {trial}: {'P' if verification['pass'] else 'F'} | {verification['reason']}")
